...
def draw_line_plot():
    # Copy the data frame for the line plot
    df_line = df.copy()
...
def draw_bar_plot():
    ...
    # Reorder the DataFrame columns based on month_order
    ...
    ax.legend(title='Months', labels=month_order)  # Ensure legend uses the correct order
